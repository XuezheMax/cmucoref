...
//        reader.startReading("data/test/original/conllx/gold/conll2012.eng.test.gold.wb.eng.conllx");
//        writer.startWriting("outfile/oracle.test.gold.wb.eng.conllx");
//        PrintStream printer = new PrintStream(new File("mention.conllx.test.gold.wb.eng.txt"));
